...
export const BiodataTab: React.FC<BiodataTabProps> = ({ biodata, setBiodata, showToast, isDemo, demoDataEdit }) => {
  const handleChange = (field: keyof Biodata, value: string) => {
    showToast("🔒 Kolom Biodata dikunci. Data hanya dapat diubah oleh administrator.");
    return;
  };

  const handleLogoUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (isDemo && !demoDataEdit) {
          ...
          <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200/60 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-white border border-slate-300 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 font-semibold disabled:bg-slate-100 disabled:text-slate-500 disabled:cursor-not-allowed"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-white border border-slate-300 rounded-xl px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:bg-slate-100 disabled:text-slate-500 disabled:cursor-not-allowed"
              />
            </div>
            <div>
              ...
              <input
                ...
                className="w-full bg-white border border-slate-300 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:bg-slate-100 disabled:text-slate-500 disabled:cursor-not-allowed"
              />
            </div>
            <div>
              ...
              <div className="grid grid-cols-3 gap-2">
                <div>
                  <select
                    ...
                    className="w-full bg-white border border-slate-300 rounded-xl px-2 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-indigo-500 font-semibold text-slate-700 disabled:bg-slate-100 disabled:text-slate-500 disabled:cursor-not-allowed"
                  >
                ...
                <div>
                  <input
                    ...
                    placeholder="Kelas"
                    className="w-full bg-white border border-slate-300 rounded-xl px-2 py-2 text-xs text-center focus:outline-none focus:ring-2 focus:ring-indigo-500 font-semibold disabled:bg-slate-100 disabled:text-slate-500 disabled:cursor-not-allowed"
                  />
                </div>
                <div>
                  <input
