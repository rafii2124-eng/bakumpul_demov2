    ...
    <div id="tab-kktp" className="tab-content space-y-6">
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 no-print space-y-4">
        ...
        <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-3">
          <p className="text-[10px] font-black uppercase tracking-wider text-emerald-800 mb-1">Capaian Pembelajaran ({biodata.fase}) — {subject}</p>
          <p className="text-[11px] leading-relaxed text-slate-700 italic">{initialCpByFase?.[subject]?.[biodata.fase] || (defaultSubjectData?.[biodata.fase]?.[subject]?.[0] || '-')}</p>
        </div>
